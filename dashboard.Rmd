...
selectInput("type", label = "ESRB rating:",
            choices = c('Platform','Rating'), selected = "Rating")
...
```{r}
renderPlot({
 plot(y=Global_Sales,x=eval(as.symbol(input$type)), main="Global Sales", col="blue",ylab="Number of Games", xlab="Copies Sold (in millions)")
